...
function validarMensaje() {
	...
	if (nombre != "") {
		...
		if (!expresion.test(nombre)) {
			$("#nombre").after('<div class="alert alert-warning">No se permiter caracteres especiales.</div>')
			return false;
		}
	}
	...
	if (mensaje != "") {
		...
		if (!expresion.test(mensaje)) {
			$("#mensaje").after('<div class="alert alert-warning">No se permiter caracteres especiales.</div>')
			return false;
		}
	}
